---
title: "Figure 5, S5 and DataS3: Core analysis"
...
ggsave(filename="output/FigureS5a_Percentage_of_core_taxa_V13.pdf", plot=p, width=10, height=3, useDingbats=FALSE, limitsize=FALSE)
...
p <- p1 + p2 + p3 + p4 + plot_layout(ncol=4)
ggsave(filename="output/FigureS5b_Percentage_of_core_taxa_V35.pdf", plot=p, width=10, height=3, useDingbats=FALSE, limitsize=FALSE)
