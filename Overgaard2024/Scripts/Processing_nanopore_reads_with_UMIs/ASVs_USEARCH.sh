...
echo Dereplicating 
usearch11 -fastx_uniques /user_data/cko/Projects/P004/Undiluted_CKO_P004_J017/Orientation/vsearch/undil_oriented.fasta -fastaout uniques.fa -sizeout -relabel uniq
