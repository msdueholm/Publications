...
path <- getwd("/user_data/cko/Projects/P004/PacBio_data/Processing/mock/dada2/filtered_minQ_minEE_default/") # CHANGE ME to location of the fastq file
fn <- list.files(pattern=".fastq")
...
tic("primers")
nop <- file.path("noprimers", basename(fn))
