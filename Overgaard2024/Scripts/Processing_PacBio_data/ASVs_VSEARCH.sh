...
module load VSEARCH/2.22.1-GCC-10.2.0


echo Dereplicate
vsearch --derep_fulllength /user_data/cko/Projects/P004/PacBio_data/Processing/mock/Orient_vsearch/filtered_default_oriented.fasta --output uniques.fa --sizeout --relabel uniq 
