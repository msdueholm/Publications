...
df_AsCoM_n <- amp_subset_samples(df_AsCoM, Compartment=="Rhizosphere", minreads = 10000, normalise = TRUE)
df_SILVA_n <- amp_subset_samples(df_SILVA, Compartment=="Rhizosphere", minreads = 10000, normalise = TRUE)
...
ggsave(filename="output/Figure4_210924_AsCoM_heatmap.pdf", plot=p1, width=10, height=10, useDingbats=FALSE, limitsize=FALSE)
ggsave(filename="output/Figure4_210924_SILVA_heatmap.pdf", plot=p2, width=10, height=10, useDingbats=FALSE, limitsize=FALSE)
```
